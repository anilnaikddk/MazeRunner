...
//            4. Mark the chosen cell as visited and push it to the stack
	...
	public RecursiveBacktrackingUsingStack(int cols, int rows, int width, int height,int originX,int originY,int startXi, int startYi){
		super(cols,rows,width,height,originX,originY,startXi,startYi);
	}
...
//	}
	...
	public void generateMaze() {
		...
		initialCell = new Cell(startXi, startYi, cellWidth,cellHeight,originX,originY);// Utils.getRandomCell(maze.length, maze[0].length, scale);
